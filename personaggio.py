...
""" creare il personaggio con cui giocare:
in un metodo 
dove gli stampo le statistiche dei 4 mostri a livello 1
gli chiedo quale vuole e il nome """

def CreaPersonaggio():
    nome_scelto = input('Insersci il nome del tuo personaggio: ')
    print(' queste sono le statistiche di tutti i mostri: ')
    drago = Drago(1,nome_scelto,"Drago")
    print(drago.stampa_statistiche())
    elfo = Elfo(1,nome_scelto,"Elfo")
    print(elfo.stampa_statistiche())
    strega = Strega(1,nome_scelto,"Strega")
    print(strega.stampa_statistiche())
    samurai = Samurai(1,nome_scelto,"Samurai")
